...
In addition to the gender fixed effect that we have already seen in the simple linear regression model, this model also provides us with an estimate of the variance in average height between families (`r summary(fit_me)$varcor$Family`) as well as the remaining (residual) variance within families (`r summary(fit_me)$sigma^2`).
